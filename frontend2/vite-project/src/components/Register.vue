          ...
          <div class="bg-white p-8 rounded-2xl shadow-sm">
            ...
            <ul class="space-y-4">
              ...
              <li class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="font-medium text-gray-900">Transaction History</h3>
                  <p class="text-gray-600">View and track all your card transactions</p>
                </div>
              </li>
              <li class="flex items-start gap-3">
                <div class="bg-blue-100 p-2 rounded-full mt-1">
                ...
                <div>
                  <h3 class="font-medium text-gray-900">Limit Management</h3>
                  <p class="text-gray-600">Control spending with flexible limit settings</p>
                </div>
              </li>
            </ul>
          ...
          <div class="bg-white shadow-sm rounded-2xl p-6">
            ...
            <div class="space-y-6 mt-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    <button
                      ...
                      class="absolute right-3 top-3 text-gray-400 hover:text-gray-600"
                    >
                      <svg v-if="showRepeatPassword" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                      </svg>
                      <svg v-else class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="bg-blue-50 p-4 rounded-lg">
                <p class="text-sm text-blue-700 mb-1 font-medium">Password requirements:</p>
              ...
              <div class="border-t border-gray-200 pt-6">
                <button
                  ...
                  :disabled="isLoading"
                  class="w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 transition-all duration-300"
                >
                ...
                <div class="mt-6 text-center">
                  <span class="text-sm text-gray-600">
                    ...
                    <a href="/login" class="text-blue-600 hover:text-blue-800 font-medium underline">Sign in</a>
                  </span>
                </div>
              </div>
            </div>
...
const validateForm = () => {
  ...
  if (!registerForm.value.fullName || registerForm.value.fullName.length < 2) {
    errors.value.fullName = 'Full name is required and must be at least 2 characters';
    isValid = false;
  }
  ...
  if (!registerForm.value.email) {
    ...
    errors.value.email = 'Email should be valid';
    isValid = false;
  }
  ...
  // Address validation
  if (!registerForm.value.address || registerForm.value.address.length < 5) {
    errors.value.address = 'Address is required and must be at least 5 characters';
    isValid = false;
  }

  // Annual Income validation
  const annualIncome = parseFloat(registerForm.value.annualIncome);
  if (!registerForm.value.annualIncome || annualIncome <= 0) {
    errors.value.annualIncome = 'Annual income must be greater than 0';
    isValid = false;
  }
  ...
  if (!registerForm.value.repeatPassword) {
    errors.value.repeatPassword = 'Please confirm your password';
    isValid = false;
